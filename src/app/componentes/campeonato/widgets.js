...
export const CampeonatoChampions = () => {
  const { t } = useTranslation();

  return (
    <Link
      href="/campeonatos/champions"
      className="
    relative w-full max-w-md mx-auto mb-10
    rounded-xl overflow-hidden
    bg-gradient-to-br from-[#0b0f1a] via-[#0f172a] to-[#020617]
  ...
  "
    >
      ...
      {/* Logo */}
      <img
        src="https://cdn.api-futebol.com.br/campeonatos/escudos/championsleague.png"
        alt="Champions League"
        className="mb-5 w-24 h-24 object-contain drop-shadow-[0_0_10px_rgba(255,165,0,0.4)]"
      />

      {/* Título */}
      <h2 className="text-2xl md:text-3xl font-light tracking-widest uppercase text-orange-400 mb-4">
        Champions League
      </h2>
